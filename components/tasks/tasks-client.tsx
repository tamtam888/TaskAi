            ...
            <TableBody>
              {visibleRows.length ? (
                visibleRows.map((row) => (
                  <TableRow
                    key={row.id}
                    className="hover:bg-violet-50 dark:hover:bg-zinc-800/50 data-[state=selected]:bg-violet-100 dark:data-[state=selected]:bg-zinc-800 transition-colors border-b border-border/50 last:border-0"
                  >
